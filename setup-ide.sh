...
if [ ! -d ./node_modules/@citychallenge/react-viro ]; then
  printf "== ERROR ==\n"
...
if $SETUP_ANDROID_STUDIO; then
  ./node_modules/@citychallenge/react-viro/bin/android-setup.sh $PROJECT_NAME true
fi

if $SETUP_XCODE; then
  ./node_modules/@citychallenge/react-viro/bin/ios-setup.sh $PROJECT_NAME true
fi
